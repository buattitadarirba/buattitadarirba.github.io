...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire({
    ...
    if (result.dismiss === Swal.DismissReason.timer) {
      Swal.fire('Todeiii 14 Feb 2024 cintakuu sayang 🤍🤍').then((result) => {
        Swal.fire({
          title: ' ',
          html: `aku, Ryandhika sayang banget sama ndoro putriku cintaku cantikknya atuu🤍🤍`,
          timer: 4500,
          timerProgressBar: true,
          showConfirmButton: false,
        }).then((result) => {
