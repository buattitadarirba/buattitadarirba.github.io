...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire({
    title: 'Aloww Sayang Tingtutt Celokotek maloppp 🤍❤️🤍!',
    ...
    if (result.dismiss === Swal.DismissReason.timer) {
      Swal.fire('Sehatt sehatt yaa sayangnya mas tingtutt malopp ❤️❤️').then((result) => {
        Swal.fire({
          title: ' ',
          html: `Semoga tanggal 21 ke dua menjadi awal dari kebahagiaan kita selanjutnya ❤️❤️`,
          timer: 2000,
          timerProgressBar: true,
          showConfirmButton: false,
          closeOnClickOutside: false,
            ...
            Swal.fire({
              ...
              if (result.dismiss === Swal.DismissReason.timer) {
                Swal.fire('Cemungutt teruss yaa sayangnya mas❤️').then((result) => {
                  Swal.fire(
                    'Happy Aniv 2 Month Sayangg !!❤️',
                    '',
                    'success'
                  ).then((result) => {
                    Swal.fire(
                      'Langgeng Teruss yaa sayangnuyaa masss❤️❤️',
                      '',
                      'success'
                    ).then((result) => {
                      Swal.fire(
                        'maaf kalau mas banyak salahnya banyak cemburu dan banyak ovtnyaa❤️❤️',
                        '',
                        'success'
                      ).then((result) => {
                        Swal.fire(
                                          ...
                                          Swal.fire(
                                            ...
                                            Swal.fire(
                                              ...
                                              Swal.fire(
                                                ...
                                                Swal.fire(
                                                  'Mas selalu ada buat sayang kapanpun dimanapun itu sayang, sayang endak sendirian, jangan dipendem sendirii yaa sayang mas disini selalu ada buat sayang ❤️❤️',
                                                  '',
                                                  'success'
                                                ).then((result) => {
                                                  Swal.fire(
